...
- Summary endpoint or embedded in session response
...
- Rounding: use banker's rounding; if amounts don't sum to grand total due to rounding, adjust the largest share
